...
main( int argc, char *argv[ ] )
{
  ...
  fprintf( stderr, "Sum of all workgroups: %f\tSum of all elements: %f\n", sum, sum0 );
   ...
   //printf( "%f, %f, %8d, %4d, %10d, %10.3lf\n",
		//sum, sum0, NMB, LOCAL_SIZE, NUM_WORK_GROUPS, (double)NUM_ELEMENTS/(time1-time0)/1000000000. );
